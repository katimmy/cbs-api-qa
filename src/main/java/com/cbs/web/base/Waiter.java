 ...
 * @create date 2022-06-03 15:54:44
 * @modify date 2022-06-03 15:54:44
 * @desc [description]
 */
...
/**
 * @author Ivan Katumba on 03/14/2022
...
public class Waiter {
     ...
     * Will wait for the TIMEOUT constant value amount of seconds for the page to
     * load.
     *
    ...
    /**
     * Method that opens a url and waits for page load complete and for a specified
    ...
    /**
     * Method that opens a URL in the browser and waits for another URL to be
     * loaded.
     * Also waits for page to load completely after expected URL is loaded in the
     * browser.
     ...
     * Compares the value resulted from getText() on the element with the expected
     * String.
     * Will wait for up to the TIMEOUT number of seconds for the text on the element
     * to be the expected one.
     *
     * @param element        - the WebElement whose text will be compared to an
     *                       expected value
     ...
     * Compares the value resulted from getText() on the element with the expected
     * String.
     * Will wait for up to the specifiedTimeout number of seconds for the text on
     * the element to be the expected one.
     *
     * @param element          - the WebElement whose text will be compared to an
     *                         expected value
     * @param expectedString   - the expected value of the WebElement's text
    ...
    /**
     * Method that waits for the text on the element to equal an expected String but
     * ignoring the case of the two.
     * Compares the value resulted from getText() on the element with the expected
     * String, but without taking into
     * account the case of the two values.
     * Therefore, for example 'tHis' and 'This' will be equal when calling this
     * method.
     * Will wait for up to the TIMEOUT number of seconds for the text on the element
     * to be the expected one.
     *
    ...
    public void waitForElementTextEqualsString_IgnoreCase(WebElement element, String expectedString, WebDriver driver,
            int specifiedTimeout) {
        WebDriverWait wait = new WebDriverWait(driver, specifiedTimeout);
        ExpectedCondition<Boolean> elementTextEqualsStringIgnoreCase = arg0 -> element.getText()
     ...
     * whitespaces are removed) to equal an expected String (whose whitespaces are
     * also removed).
     * Basically, does a getText() on the WebElement, removes all whitespaces from
     * this resulting String, then compares
     ...
     * When calling the method, the expectedString can contain whitespaces, as they
     * are removed inside this method.
     * Therefore, 'this string here' will equal 'this string here'.
     * Will wait for up to the TIMEOUT number of seconds for the text on the element
     * to be the expected one.
     *
     * @param element        - the WebElement whose text will be compared to an
     *                       expected value after removing the
     *                       whitespaces on this text
     * @param expectedString - the expected value of the WebElement's text on which
     *                       a whitespace removal is also done
     * @param driver         - the WebDriver instance
     */
    public void waitForElementTextEqualsString_IgnoreWhitespaces(WebElement element, String expectedString,
            WebDriver driver) {
     ...
     *                         expected value after removing the
     *                         whitespaces on this text
     * @param expectedString   - the expected value of the WebElement's text on
     *                         which a whitespace removal is also done
     * @param driver           - the WebDriver instance
     * @param specifiedTimeout - amount of seconds you want to wait for
     */
    public void waitForElementTextEqualsString_IgnoreWhitespaces(WebElement element, String expectedString,
        ...
        WebDriverWait wait = new WebDriverWait(driver, specifiedTimeout);
        ExpectedCondition<Boolean> elementTextEqualsString = arg0 -> element.getText().replaceAll("\\s", "")
     ...
     * Checks whether the value resulted from getText() on the element contains the
     * expected String.
     * Will wait for up to the TIMEOUT number of seconds for the text on the element
     * to contain the expected one.
     *
     * @param element        - the WebElement whose text will be checked
     * @param expectedString - the value expected to be contained in the
     *                       WebElement's text
     * @param driver         - the WebDriver instance
     */
     ...
     * expected String.
     * Will wait for up to the specifiedTimeout number of seconds for the text on
     * the element to contain the expected one.
     *
     * @param element          - the WebElement whose text will be checked
     * @param expectedString   - the value expected to be contained in the
     *                         WebElement's text
    ...
    /**
     * Method that waits for the text on the element to contain an expected String
     * but ignoring the case of the two.
     * Checks whether the value resulted from getText() on the element contains the
     * expected String, but without taking
     ...
     *
     * @param element        - the WebElement whose text will be checked
     * @param expectedString - the value expected to be part of the WebElement's
     *                       text, ignoring the case
     * @param driver         - the WebDriver instance
     */
    ...
    public void waitForElementTextContainsString_IgnoreCase(WebElement element, String expectedString, WebDriver driver,
            int specifiedTimeout) {
        WebDriverWait wait = new WebDriverWait(driver, specifiedTimeout);
        ExpectedCondition<Boolean> elementTextContainsString = arg0 -> element.getText().toLowerCase()
    ...
    /**
     * Method that waits for the text on the element (whose
     * whitespaces are removed) to contain an expected String (whose whitespaces are
     * also removed).
     * Basically, does a getText() on the WebElement, removes all whitespaces from
     * this resulting String, then checks
     ...
     *                       whitespaces on this text
     * @param expectedString - the value expected to be part of the WebElement's
     *                       text on which a whitespace removal is
     *                       also done
     * @param driver         - the WebDriver instance
     */
    public void waitForElementTextContainsString_IgnoreWhitespaces(WebElement element, String expectedString,
            WebDriver driver) {
    ...
    public void waitForElementTextContainsString_IgnoreWhitespaces(WebElement element, String expectedString,
            WebDriver driver, int specifiedTimeout) {
        WebDriverWait wait = new WebDriverWait(driver, specifiedTimeout);
        ExpectedCondition<Boolean> elementTextContainsString = arg0 -> element.getText().replaceAll("\\s", "")
    ...
    /**
     * Method that waits for an element's specified attribute's value to equal
     * another specified String.
     * Compares the value resulted from getAttribute(nameOfAttribute) on the element
     * with the expected String.
     * Will wait for up to the TIMEOUT number of seconds for an element's attribute
     * value to equal an expected String.
     *
     * @param element        - the WebElement whose attribute we are interested in
     * @param attribute      - the attribute whose value needs to be compared to
     *                       another value
     ...
     * Compares the value resulted from getAttribute(nameOfAttribute) on the element
     * with the expected String.
     * Will wait for up to the specified number of seconds for an element's
     * attribute value to equal an expected String.
     *
     * @param element          - the WebElement whose attribute we are interested in
     * @param attribute        - the attribute whose value needs to be compared to
     *                         another value
    ...
    /**
     * Method that waits for an element's specified attribute's value to equal
     * another specified String, no matter
     * the case of the actual or expected value.
     * Compares the value resulted from getAttribute(nameOfAttribute) on the element
     * with the expected String,
     * ignoring the cases.
     * Will wait for up to the TIMEOUT number of seconds for an element's attribute
     * value to equal an expected
     ...
     * @param driver         - the WebDriver instance
     */
    public void waitForElementAttributeEqualsString_IgnoreCase(WebElement element, String attribute,
            String expectedString, WebDriver driver) {
    ...
    /**
     * Method that waits for an element's attribute value (whose whitespaces are
     * removed) to equal an expected
     * String (whose whitespaces are also removed).
     * Basically, does a getAttribute(nameOfAttribute) on the WebElement, removes
     * all whitespaces from this resulting
     * String, then compares this value to another String that contains no
     * whitespaces.
     * When calling the method, the expectedString can contain whitespaces, as they
     * are removed inside this method.
     * Whitespaces include: space, new line, tab.
     * Having said that, only the non whitespace characters are compared.
     * Therefore, 'this string here' will equal 'this string here'.
     * Will wait for up to the TIMEOUT number of seconds for expected condition to
     * occur.
     *
     * @param element        - the WebElement whose attribute will be verified
     * @param attribute      - the attribute whose value will be verified
     * @param expectedString - the expected value of the WebElement's attribute on
     *                       which a whitespace removal is also
     *                       done
     * @param driver         - the WebDriver instance
     */
    public void waitForElementAttributeEqualsString_IgnoreWhitespaces(WebElement element, String attribute,
            String expectedString, WebDriver driver) {
     ...
     * Having said that, only the non whitespace characters are compared.
     * Therefore, 'this string here' will equal 'this string here'.
     * Will wait for up to the specified timeout number of seconds for expected
     * condition to occur.
     *
     * @param element          - the WebElement whose attribute will be verified
     * @param attribute        - the attribute whose value will be verified
     ...
     *                         done
     * @param driver           - the WebDriver instance
     * @param specifiedTimeout - the amount of seconds to wait for the condition to
     *                         occur
     */
    public void waitForElementAttributeEqualsString_IgnoreWhitespaces(WebElement element, String attribute,
            String expectedString, WebDriver driver, int specifiedTimeout) {
    ...
    /**
     * Method that waits for an element's specified attribute's value to contain
     * another specified String.
     * Compares the value resulted from getAttribute(nameOfAttribute) on the element
     * with the expected String.
     ...
     * Compares the value resulted from getAttribute(nameOfAttribute) on the element
     * with the expected String.
     * Will wait for up to the specified number of seconds for the condition to
     * occur.
     *
     * @param element          - the WebElement whose attribute we are interested in
     * @param attribute        - the attribute whose value needs to be compared to
    ...
    public void waitForElementAttributeContainsString(WebElement element, String attribute, String expectedString,
            WebDriver driver, int specifiedTimeout) {
        WebDriverWait wait = new WebDriverWait(driver, specifiedTimeout);
        ExpectedCondition<Boolean> elementAttributeContainsString = arg0 -> element.getAttribute(attribute)
     ...
     * @param driver         - the WebDriver instance
     */
    public void waitForElementAttributeContainsString_IgnoreCase(WebElement element, String attribute,
            String expectedString, WebDriver driver) {
     ...
     * with the expected String,
     * ignoring the cases.
     * Will wait for up to the specifiedTimeout number of seconds for the expected
     * condition to occur.
     *
     * @param element          - the WebElement whose attribute we are interested in
     * @param attribute        - the attribute whose value needs to be compared to
     ...
     * Having said that, only the non whitespace characters are compared.
     * Therefore, 'this string here' will equal 'this string here'.
     * Will wait for up to the TIMEOUT timeout number of seconds for expected
     * condition to occur.
     *
     * @param element        - the WebElement whose attribute will be verified
     * @param attribute      - the attribute whose value will be verified
     ...
     * @param driver         - the WebDriver instance
     */
    public void waitForElementAttributeContainsString_IgnoreWhitespaces(WebElement element, String attribute,
            String expectedString, WebDriver driver) {
    ...
    /**
     * Method that waits for an element's attribute value (whose whitespaces are
     * removed) to contain an expected
     * String (whose whitespaces are also removed).
     * Basically, does a getAttribute(nameOfAttribute) on the WebElement, removes
     * all whitespaces from this resulting
     * String, then compares this value to another String that contains no
    ...
    /**
     * Wait for an expected URL to load in the browser, but ignore the case of the
     * url.
     * Compares a lower case value of the actual url in the browser with the lower
     * case value of the expected url.
     ...
     * Wait for the specifiedTimeout number of seconds.
     *
     * @param url              - the url expected to load in the browser, ignoring
     *                         its case
     * @param driver           - the WebDriver instance
     * @param specifiedTimeout - amount of seconds you want to wait for
     */
    public void waitForUrl_IgnoreCase(String url, WebDriver driver, int specifiedTimeout) {
        WebDriverWait wait = new WebDriverWait(driver, specifiedTimeout);
        ExpectedCondition<Boolean> urlIsCorrect = arg0 -> driver.getCurrentUrl().toLowerCase()
    ...
    /**
     * Wait for a URL containing a specified String to open in the browser, ignoring
     * the case of the url.
     * Checks whether a lower case value of the actual URL contains a lower case
     * value of the expected String.
     * Wait for the TIMEOUT number of seconds.
     *
     * @param expectedString - the String that needs to be included in the URL
     * @param driver         - the WebDriver instance
     ...
     * Please see the startsWith method from the String class for details on how
     * this method determines whether a
     * String starts with another one.
     * Wait for the TIMEOUT number of seconds.
     *
     * @param expectedString - the expected String to be found at the start of the
    ...
    /**
     * Click on a WebElement and than wait for a specified URL to load in the
     * browser.
     * Wait for TIMEOUT number of seconds.
     *
    ...
    /**
     * Click on a WebElement and than wait for the URL that loads in the browser to
     * contain a specified String.
     * Wait for the TIMEOUT number of seconds.
     *
     * @param element             - the WebElement to click on
     * @param expectedStringInUrl - the String you expect to be contained in the URL
     *                            that loads after clicking the
     *                            WebElement
     * @param driver              - the WebDriver instance
     */
     ...
     * @param driver              - the WebDriver instance
     */
    public void clickElementAndWaitForUrlContains_IgnoreCase(WebElement element, String expectedStringInUrl,
            WebDriver driver) {
    ...
    /**
     * Click on a WebElement and wait for the URL in the browser to start with an
     * expected String.
     * Wait for the TIMEOUT number of seconds.
     *
     * @param element        - the WebElement to click on
     * @param expectedString - the String you expected the URL in the browser to
     *                       start with
     * @param driver         - the WebDriver instance
     */
    public void clickElementAndWaitForUrlStartsWith(WebElement element, String expectedString, WebDriver driver) {
    ...
    /**
     * Click on an element and wait for a page refresh. To be used when you want the
     * same page to reload after
